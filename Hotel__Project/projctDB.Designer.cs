...
namespace Hotel__Project {
    ...
    [global::System.Xml.Serialization.XmlRootAttribute("projctDB")]
    [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")]
    public partial class projctDB : global::System.Data.DataSet {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        protected projctDB(global::System.Runtime.Serialization.SerializationInfo info, global::System.Runtime.Serialization.StreamingContext context) : 
        ...
        public override global::System.Data.DataSet Clone() {
            projctDB cln = ((projctDB)(base.Clone()));
            cln.InitVars();
        ...
        private void InitClass() {
            this.DataSetName = "projctDB";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/projctDB.xsd";
        ...
        public partial class customerDataTable : global::System.Data.TypedTableBase<customerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public customerRow AddcustomerRow(string cname, long mobile, string nationality, string gender, string dob, string idproof, string addres, string checkin, string checkout, string chekout, int room_id) {
        ...
        public partial class customerRow : global::System.Data.DataRow {
            ...
            public int room_id {
                get {
                    return ((int)(this[this.tablecustomer.room_idColumn]));
                }
                set {
                    this[this.tablecustomer.room_idColumn] = value;
                }
            }
...
namespace Hotel__Project.projctDBTableAdapters {
    ...
    public partial class customerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[customer] ([cname], [mobile], [nationality], [gender], [dob], [idproof], [addres], [checkin], [checkout], [chekout], [room_id]) VALUES (@cname, @mobile, @nationality, @gender, @dob, @idproof, @addres, @checkin, @checkout, @chekout, @room_id);
SELECT cid, cname, mobile, nationality, gender, dob, idproof, addres, checkin, checkout, chekout, room_id FROM customer WHERE (cid = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[customer] SET [cname] = @cname, [mobile] = @mobile, [nationality] = @nationality, [gender] = @gender, [dob] = @dob, [idproof] = @idproof, [addres] = @addres, [checkin] = @checkin, [checkout] = @checkout, [chekout] = @chekout, [room_id] = @room_id WHERE (([cid] = @Original_cid) AND ([cname] = @Original_cname) AND ([mobile] = @Original_mobile) AND ([nationality] = @Original_nationality) AND ([gender] = @Original_gender) AND ([dob] = @Original_dob) AND ([idproof] = @Original_idproof) AND ([addres] = @Original_addres) AND ([checkin] = @Original_checkin) AND ((@IsNull_checkout = 1 AND [checkout] IS NULL) OR ([checkout] = @Original_checkout)) AND ([chekout] = @Original_chekout) AND ([room_id] = @Original_room_id));
SELECT cid, cname, mobile, nationality, gender, dob, idproof, addres, checkin, checkout, chekout, room_id FROM customer WHERE (cid = @cid)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Hotel__Project.Properties.Settings.Default.Hotel_management_DBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT cid, cname, mobile, nationality, gender, dob, idproof, addres, checkin, ch" +
                "eckout, chekout, room_id FROM dbo.customer";
        ...
        public virtual int Fill(projctDB.customerDataTable dataTable) {
        ...
        public virtual projctDB.customerDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            projctDB.customerDataTable dataTable = new projctDB.customerDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(projctDB.customerDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(projctDB dataSet) {
        ...
        public virtual int Delete(int Original_cid, string Original_cname, long Original_mobile, string Original_nationality, string Original_gender, string Original_dob, string Original_idproof, string Original_addres, string Original_checkin, string Original_checkout, string Original_chekout, int Original_room_id) {
            ...
            this.Adapter.DeleteCommand.Parameters[12].Value = ((int)(Original_room_id));
        ...
        public virtual int Insert(string cname, long mobile, string nationality, string gender, string dob, string idproof, string addres, string checkin, string checkout, string chekout, int room_id) {
            if ((cname == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[10].Value = ((int)(room_id));
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[23].Value = ((int)(Original_room_id));
        ...
        public virtual int Update(
                    ...
                    string Original_chekout, 
                    int Original_room_id) {
            return this.Update(cname, mobile, nationality, gender, dob, idproof, addres, checkin, checkout, chekout, room_id, Original_cid, Original_cname, Original_mobile, Original_nationality, Original_gender, Original_dob, Original_idproof, Original_addres, Original_checkin, Original_checkout, Original_chekout, Original_room_id, Original_cid);
        }
    }
...
SELECT eid, ename, mobile, gender, email, username, pass FROM employee WHERE (eid = @eid)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT eid, ename, mobile, gender, email, username, pass FROM dbo.employee";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(projctDB.employeeDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual projctDB.employeeDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            projctDB.employeeDataTable dataTable = new projctDB.employeeDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(projctDB.employeeDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        private int UpdateUpdatedRows(projctDB dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._customerTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        private int UpdateInsertedRows(projctDB dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._customerTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        private int UpdateDeletedRows(projctDB dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._employeeTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        public virtual int UpdateAll(projctDB dataSet) {
            if ((dataSet == null)) {
